...
Canonical page: https://yingwen.io/zh/publications/accelerating-multi-turn-llm-agent-workflows-via-context-templating-and-opportunistic-prefill/
...
Topics: [大模型与推理](https://yingwen.io/zh/research/llms/); [大模型智能体](https://yingwen.io/zh/research/llm-agents/); [多智能体博弈与开放式学习](https://yingwen.io/zh/research/multi-agent/)
