...
Type: Preprint
Canonical page: https://yingwen.io/en/publications/jailbreakskill-scaling-automated-red-teaming-with-reusable-and-ever-evolving-skills/
...
Topics: [Large language models & reasoning](https://yingwen.io/en/research/llms/); [LLM agents](https://yingwen.io/en/research/llm-agents/)
