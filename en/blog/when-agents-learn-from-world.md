...
Wen, Y. (2026, March 15). *When Agents Learn from the World, Not from Us*. Preprint.
...
[English Preprint · PDF ↗](https://yingwen.io/preprints/when-agents-learn-from-world.pdf) · [BibTeX ↓](https://yingwen.io/preprints/when-agents-learn-from-world.bib)
