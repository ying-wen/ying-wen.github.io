...
Wen, Y. (2026, August 24). *From Search Scaling to Learning Scaling: Task-Time Search, Runtime Continual Learning, and Recursive Improvement*. Preprint.
...
[English Preprint · PDF ↗](https://yingwen.io/preprints/search-scaling-to-learning-scaling.pdf) · [BibTeX ↓](https://yingwen.io/preprints/search-scaling-to-learning-scaling.bib)
